    ...
    <div>
      ...
      <div className=' mt-4 p-4 grid grid-cols-1 sm:grid-cols-2 gap-[100px] items-center justify-center mb-10'>
        <div className='hidden md:flex flex-col items-center justify-center relative'>
          ...
          <p className='text-md ml-4 p-4 flex items-center'>Sathy to Erode Highwyas, Puliyampatti pirivu,<br /> Ariyappampalayam, Sathyamangalam,<br /> Erode district, Tamil Nadu-638402.</p>
          <a href='/'>
        ...
        <div className='flex flex-col items-center justify-center relative'>
          ...
          <p className='text-md flex items-center ml-4 p-4'>14, 15, New Bus Stand Complex,<br /> Sathyamangalam, Erode district,<br /> Tamil Nadu-638402</p>
          <a href='/electronics'>
            <button className='mt-4 bg-white p-4 text-[#5a005b] font-semibold rounded-lg'>Explore Now &gt;</button>
          </a>
        </div>
